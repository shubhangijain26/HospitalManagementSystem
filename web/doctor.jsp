			...
			<div class="row">
					...
					<div class="dropdown">
						<button type="button" class="btn btn-primary dropdown-toggle form-control" data-toggle="collapse" data-target="#collapse1">
						  ...
						  <div class="collapse" id="collapse1">
							<div class="collapse" id="collapse1">
							<a href="#" class="dropdown-item" onclick="showProfile()"><i class='fas fa-address-card' style='font-size:20px'></i> Profile</a><br>
							<a href="#" class="dropdown-item" onclick="todayAppointment()"><i class='fas fa-calendar' style='font-size:20px'></i>  Today's Appointment with patient</a><br>
							<!-- <a href="#" class="dropdown-item"><i class='far fa-comments' style='font-size:20px'></i>  Chat with patients</a><br> -->
						  </div>
						  </div>
					</div>
					<hr>
					<div class="dropdown">
						<button type="button" class="btn btn-primary dropdown-toggle form-control" data-toggle="collapse" data-target="#collapse2">
						  ...
						  <div class="collapse" id="collapse2">
						    ...
						    <a class="dropdown-item" href="#"><i class='fas fa-pills' style='font-size:20px'></i>  Chat with patients</a><br>
						  </div>
					</div>
				</div>
				...
				<div class="col-sm-8" style="padding: 10px">
					...
					<div class="container-fluid" id="showAllPatient" style="display: none">
						...
						<input type="button" class="btn btn-secondary"  value="show patient"  onclick="#">
					</div>
					...
					<div class="container-fluid" id="todayAppointment" style="display: none">
						<div class="background"></div>
						<input type="button" class="btn btn-secondary"  value="Today's appointment with patients"  onclick="#">
					</div>
...
document.getElementById('dshow').innerHTML=result;  
}  
}  
  
</script>

					<div class="media border p-5" id="dDetails">
					  <img src="imgs/login1.png" alt="patient" class="mr-3 mt-3 rounded-circle" style="width:200px;">
						 
						   <form name="vinform">
                                         <input type="text" required="" name="t1"  class="form-control"  placeholder="Doctor Id" ><br>
                                         </form>
						  <div class="media-body">
						    <button type="button" class="btn btn-primary" onclick="sendDoctor()">View Details</button>
						  </div>
                                          <br>
                                          <span id="dshow"></span>
					  ...
					  <br><br>
					   <button type="button" class="btn btn-primary form-control"  id="dSummaryId" data-toggle="collapse" data-target="#collapse3"><i class='fas fa-plus' style='font-size:20px'></i>&nbsp &nbsp Credentials</button>
